                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control @error('salutation') is-invalid @enderror" name="salutation">
                                    <option disabled selected>Choose Salutation</option>
                                    <option {{ old('salutation') == 'mr' ? 'selected' : '' }} value="mr">Mr</option>
                                    <option {{ old('salutation') == 'ms' ? 'selected' : '' }} value="ms">Ms/Mrs</option>
                                    <option {{ old('salutation') == 'mx' ? 'selected' : '' }} value="mx">Mx</option>
                                </select>
                                @error('salutation')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
